...
- pull out the district numbers that are in each cluster of interest
- subset crime to just these districts within the cluster (from original df, not grouped)
