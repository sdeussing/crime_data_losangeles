...
```{r Clusters of interest}
clust1 <- clust_crime %>% filter(Cluster_Num == 1)
clust4 <- clust_crime %>% filter(Cluster_Num == 4)
clust10 <- clust_crime %>% filter(Cluster_Num == 10)
clust11 <- clust_crime %>% filter(Cluster_Num == 11)
```
