...
new <- new %>% select(Crime_Code_Desc, Crime_Code, Part_1_2)%>% distinct(Crime_Code_Desc,Crime_Code, Part_1_2) %>%  arrange(Part_1_2, Crime_Code) %>%  mutate(Crime_Rank = row_number())
